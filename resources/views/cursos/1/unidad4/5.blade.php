<link href="{{asset('/css/jamarrom/encuesta.css')}}" rel="stylesheet" type="text/css">
        ...
        <div class="Pregunta-Col u-inline-block">
            ...
            <div class="Pregunta-Resultados u-inline-block">
                ...
                <div class="Pregunta-TxtsResultados">
                    <p class="Respuesta1">Te invitamos a realizar nuevamente el ejercicio para mejorar su calificación
                    </p>

                    <p class="Respuesta1 u-textRight"><a class="u-inline-block" href="">Reintentar</a></p>
