        ...
        <div class="Curso-ContentUnidades u-inline-block">
            ...
            <div>
                ...
                <ul class="Unidad-ListMenuUnidad">
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 2, 'tema' => 1])}}" class="activo u-inline-block"><strong>2.1</strong> Objetivo
                            de Aprendizaje</a></li>
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 2, 'tema' => 2])}}" class="u-inline-block"><strong>2.2</strong>
                            Introducción</a></li>
                    <li><a href="" class="u-inline-block NoDisponible"><strong>2.3</strong> Sistema PEMEX-SSPA</a></li>
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 2, 'tema' => 4])}}"
                ...
                <ul class="Unidad-ListMenuUnidad" style="display: none;">
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 4, 'tema' => 1])}}" class="activo u-inline-block"><strong>4.1</strong> Objetivo
                            de Aprendizaje</a></li>
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 4, 'tema' => 2])}}" class="u-inline-block"><strong>4.2</strong>
                            Introducción</a></li>
                    ...
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 4, 'tema' => 4])}}"
                            class="u-inline-block"><strong>4.4</strong> Uso y manejo de mangueras contraincendio</a>
                    </li>
                    <li><a href="{{route('curso.unidad', ['curso_id' => 1, 'unidad_id' => 4, 'tema' => 5])}}"
